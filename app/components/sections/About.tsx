      ...
      <div className="block lg:hidden mx-auto mb-6 w-[86%] text-center">
        <FadeUp delay={0.2}>
          <div className="inline-flex items-center gap-2 rounded-full border border-pink-200/80 bg-white/90 px-3.5 py-1.5 shadow-2xs backdrop-blur-md">
            ...
            <span className="text-[9px] font-mono font-extrabold uppercase tracking-[0.28em] text-pink-600 sm:text-xs">{t("aboutBadge")}</span>
          </div>
        </FadeUp>
      </div>
            ...
            <FadeUp delay={0.1}>
              <div className="relative rounded-[24px] bg-gradient-to-b from-white via-pink-50/60 to-pink-100/30 p-2.5 border border-pink-200/80 shadow-[0_20px_50px_rgba(233,106,152,0.1)] sm:rounded-[44px] sm:p-3">
                ...
                <div className="relative overflow-hidden rounded-[18px] bg-pink-50/50 sm:rounded-[36px]">
                  ...
                  <Image src="/hero/sandra.png" alt={t("profileImageAlt")} width={900} height={1200} className="h-auto w-full object-cover transition-transform duration-700 ease-out hover:scale-[1.02]" priority />
                </div>
              </div>
            </FadeUp>
              ...
              <div className="absolute -bottom-5 left-1/2 z-20 w-[88%] -translate-x-1/2 rounded-2xl border border-white/90 bg-white/95 p-3.5 shadow-[0_12px_40px_rgba(233,106,152,0.18)] backdrop-blur-xl sm:-right-6 sm:bottom-8 sm:left-auto sm:w-auto sm:translate-x-0 sm:rounded-3xl sm:p-5">
                <div className="flex items-center gap-3.5">
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-pink-600 to-rose-400 text-white shadow-md shadow-pink-500/25 sm:h-12 sm:w-12">
                    <span className="text-base font-black tracking-tight sm:text-xl">6+</span>
                  </div>
                  <div className="min-w-0 pr-1 text-left">
                    <p className="text-[8px] font-mono font-bold uppercase tracking-[0.18em] text-pink-600 sm:text-xs">{t("aboutExpTitle")}</p>
                    <p className="text-[11px] font-bold leading-snug text-[#2D2433] sm:text-sm">{t("aboutExpSubtitle")}</p>
                  </div>
                </div>
              </div>
            </FadeUp>
          ...
          <div className="mx-auto w-full">
            <FadeUp delay={0.25}>
              <div className="hidden lg:block">
                <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-pink-200/80 bg-white/90 px-3.5 py-1.5 shadow-2xs backdrop-blur-md">
                  <span className="h-1.5 w-1.5 rounded-full bg-pink-500 animate-pulse" />
                  <span className="text-[10px] font-mono font-extrabold uppercase tracking-[0.3em] text-pink-600 sm:text-xs">{t("aboutBadge")}</span>
                </div>
              </div>
            </FadeUp>
              ...
              <div className="mx-auto mt-7 grid max-w-[350px] grid-cols-2 gap-5 border-t border-pink-100/80 pt-6 sm:mt-8 sm:max-w-none sm:gap-6 sm:pt-7">
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <h4 className="mt-0.5 text-[10px] font-bold leading-snug text-[#2D2433] sm:text-lg">{t("aboutLocation")}</h4>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2.5 sm:gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <h4 className="mt-0.5 text-[10px] font-bold leading-snug text-[#2D2433] sm:text-lg">{t("availabilityStatus")}</h4>
                  </div>
                </div>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.56}>
              <div className="mx-auto mt-7 max-w-[350px] sm:mt-7 sm:max-w-none">
                <p className="text-center text-[9px] font-mono font-bold uppercase tracking-[0.22em] text-pink-400 sm:text-xs">{t("specialtiesTitle")}</p>
                <div className="mx-auto mt-3 flex max-w-[340px] flex-wrap justify-center gap-2 sm:max-w-none sm:gap-2.5">
                  {specialties.map((item) => (
                    <span key={item} className="inline-flex items-center justify-center rounded-full border border-pink-200/70 bg-white px-3 py-1 text-center text-[9px] font-bold text-[#2D2433] transition-all duration-300 hover:-translate-y-0.5 hover:border-pink-400 hover:bg-pink-50/70 hover:text-pink-600 hover:shadow-sm hover:shadow-pink-500/10 cursor-default sm:px-3.5 sm:py-1.5 sm:text-[10px]">{item}</span>
                  ))}
                </div>
              </div>
            </FadeUp>
